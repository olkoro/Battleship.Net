...
namespace DAL.Migrations
{
    ...
    [Migration("20181129182416_DbMigration11")]
    partial class DbMigration11
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.BoardShips", b =>
                {
                    b.Property<int>("BoardShipsId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("DAL.SaveState", b =>
                {
            ...
            modelBuilder.Entity("DAL.SaveState", b =>
                {
                    b.HasOne("DAL.Save", "Save")
                        .WithMany()
                        .HasForeignKey("SaveId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DAL.State", "State")
                        .WithMany()
